...
На втором графике представлена полиномиальная аппроксимация функции, синие точки исходные данные из point.csv, зеленая линия полиномиальная аппроксимация, полученная с использованием полинома третьей степени.

![График](pol.png)

На картинке показан вывод функции в терминале
